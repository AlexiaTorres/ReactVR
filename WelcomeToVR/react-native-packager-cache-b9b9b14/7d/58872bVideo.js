...
var _jsxFileName = '/home/alexia11/Projectos/ReactVR/WelcomeToVR/node_modules/react-vr/Libraries/Video/Video.js';
...
var Video = React.createClass({
  ...
  _registerUserGesture: function _registerUserGesture(commandID, commandArgs, reactTag) {
    UIManager.dispatchViewManagerCommand(reactTag, UIManager.Video.Commands.setImmediateOnTouchEnd, ['touchend', ReactNative.findNodeHandle(this), commandID, commandArgs]);
  },
  _unregisterUserGesture: function _unregisterUserGesture(reactTag) {
    UIManager.dispatchViewManagerCommand(reactTag, UIManager.Video.Commands.setImmediateOnTouchEnd, []);
  },
  _play: function _play() {
    UIManager.dispatchViewManagerCommand(ReactNative.findNodeHandle(this), UIManager.Video.Commands.play, []);
  },
  _pause: function _pause() {
    UIManager.dispatchViewManagerCommand(ReactNative.findNodeHandle(this), UIManager.Video.Commands.pause, []);
  },
  _seekTo: function _seekTo(timeSec) {
    UIManager.dispatchViewManagerCommand(ReactNative.findNodeHandle(this), UIManager.Video.Commands.seekTo, [timeSec]);
  },
